    ...
    function LoadingRepo() {
      return (<div className="flex h-full w-screen mt-[5%] justify-center">
            ...
            <h1 className="text-start text-xl font-medium">Most Stars </h1>
                ...
                <div className="mt-6 flex flex-col gap-4">
                {[...Array(8)].map((_, i) => <div key={i} className="animate-pulse bg-[#080808] border border-[#343434] h-16 w-[600px] p-1.5 rounded-md" />)}
                </div> 
               <div className="empty opacity-0 h-[70px]"></div>
            </div>
            <div className=" flex flex-col fixed pr-6 gap-10 mt-[5%] ml-[0%] right-0 z-[500]">
                ...
                <p className="text-sm font-medium mb-4">Sort by</p>
                <label className="flex gap-2 items-center">
                    <input type="radio" name="filter" value="stars" className="input" />
                    Most Stars
                    </label>
                    
                <label className="flex gap-2 items-center">
                    <input type="radio" name="filter" value="updated" />
                    Newest Update
                </label>
